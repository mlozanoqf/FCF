...
* **Projects.** Within each workspace, there are three main projects. The first project is named after the course (ARF1, ARF2, EMF, or IF), and it is open for editing by the entire class. The second project is a read-only project that contains feedback, activity instructions, and exam solutions. The third project is named after your group. This project is private and can only be edited by your group and me.
